...
const TRANSITIONS: Record<GameState, GameState[]> = {
  ...
  [GameState.TUTORIAL]: [GameState.PLAYING, GameState.MAIN_MENU, GameState.PAUSED, GameState.GAME_OVER],
  [GameState.PLAYING]: [GameState.PAUSED, GameState.GAME_OVER, GameState.MAIN_MENU],
  [GameState.PAUSED]: [GameState.PLAYING, GameState.TUTORIAL, GameState.MAIN_MENU, GameState.SETTINGS],
